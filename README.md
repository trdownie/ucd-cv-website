CV Website: Terry Downie
This website is the live CV of myself, Terry Downie. It is responsive, therefore accessible on a range of devices. The purpose of this site is to secure employment and seek collaboration. This website also forms part of my diploma in Full Stack Development with the Code Institute, specifically user-centric frontend development. As such, this site has been developed strictly using HTML5 and CSS3.
...
The secondary users of this site will be collaborators. They will want:
1.	To be able to easily navigate around the site.
...
Design
Strategy
The strategy of the website must be focussed with meeting the needs of user outlined above. Anything superfluous to that is often to the detriment of user experience more than to its benefit, and due to the narrow focus of this project any additional considerations are not a priority.
...
Scope
The scope of the goal is to achieve the strategic objectives outlined above. The most practical way to serve this end it to present a single flow of information that users can follow to achieve their respective list of information needs. Any detour from this single flow of information will only complicate the channel between the site and the user that information must flow through, therefore inhibiting the project’s success.
...
o	About me, conveying value to the users without too much information
o	Work/education history, in an easily accessible and logical way
o	Skills, including my level of competence for specific skills, and in the order of competence for return users
o	Projects, with the most recent projects at the top to accommodate return visitors
...
o	A welcome message
o	A reassurance that the website is what the user is looking for
o	An image of me
o	Something to add flare that makes the user want to continue
...
As you can see, the layout reinforces the usefulness of the site: to funnel users towards the ultimate CTA, to contact me. Each section is clearly defined and the site employs contrasting light and dark pages, a key design element which will be explored in the surface section.
...
The programming skills progress bar chart was taken from Camila Carrera on CodePen. https://codepen.io/milacarrera/pen/pEPoZz I adapted the colours, timings and formatting to suit the theme of my site, but I thought the aesthetics of it were improved over the original mock-ups and so utilised this.
 
Projects
During development of the projects page, a random guttering appeared to the right of the elements in the Gitpod viewer. This was distorting the project element width as Bootstrap was taking it into account as part of its 12-section row, but only for this section. I couldn’t find the cause after disabling pretty much everything I could think it might be. In the end, the code below was found here (https://stackoverflow.com/questions/4617872/white-space-showing-up-on-right-side-of-page-when-background-image-should-extend) and turned out to fix the problem completely.
html, body
{
    width: 100%;
    height: 100%;
...
•	Skip to main has been implemented before the navigation section. The code was adapted from (https://accessibility.oit.ncsu.edu/it-accessibility-at-nc-state/developers/accessibility-handbook/mouse-and-keyboard-events/skip-to-main-content/)
...
Frameworks, Libraries & Tools (links) (Red ones are still copies – TBC)
•	Git was used for version control. (https://git-scm.com/)
•	GitHub was used to host the repository and to deploy the website via GitHub pages.  (https://github.com/)
•	Gitpod was used as a development area. (https://www.gitpod.io/)
•	Bootstrap 4.1.3 was used for layout, responsiveness and some styling. (https://getbootstrap.com/)
•	Google fonts were used to import the two fonts used, Montserrat and Roboto. (https://fonts.google.com/)
•	Font Awesome was used for some icons to ensure an aesthetic look. (https://fontawesome.com/)
•	ICONSFLOW was used for some icons to ensure an aesthetic looks. (https://iconsflow.com/)
•	Hover.css was used to grow the links throughout the page.( https://ianlunn.github.io/Hover/)
•	Canva was used to edit the image and some icons before importing into Gitpod. (https://www.canva.com/en_gb/)
•	Figma was used to create the wireframes and mockups during the design process.( https://www.figma.com/)
•	MS Word was used to type this README before deployment. (https://www.microsoft.com/en-gb/microsoft-365/word)
...
•	W3C Markup Validator: Pass no errors (http://validator.w3.org)
•	W3C CSS Validator: Pass no errors (https://jigsaw.w3.org/css-validator/)
•	Rakko HTML5 validator: Pass no errors (https://en.rakko.tools/tools/58/)
•	W3C Link checker: Pass no errors (https://validator.w3.org/checklink)
...
4.	To obtain key information about me, specifically:
o	My education/work history.
o	My current skillset with competence levels where applicable.
o	The projects I have worked on.
...
1.	To be able to easily navigate around the site.
2.	This is again achieved via a preferred and directed navigation method of using the arrows to flow through the single page site. Additionally, there is a conventional navigation menu, alongside responsive design and accessibility measures.

3.	To understand immediately and with definitive clarity the purpose of the site and its relevance to them in their search for collaborators.
...
4.	To get a glimpse of my personality and what my values are.
•	My life philosophy and my core values are provided.

5.	To obtain key information about me, specifically:
o	My current skillset with competence levels where applicable.
o	The projects I have worked on and the briefs I have worked to in these projects.
•	Both of these elements have their own section, and front and centre of each project there is a single sentence brief.

6.	To be able to contact me in their preferred manner.
...
o	Any missing info returns an error message.
o	An incorrect email format returns an error message.
o	The correct info doesn’t do anything yet as the backend isn’t configured. (To be updated.)
...
Future Improvements
Navigation
At a future date I will make the menu bar into a sticky using JS, using alternative colours for each sections as per mock-ups.
...
o	https://www.456bereastreet.com/lab/developing_with_web_standards/structure/
•	The Accessibility Checklist I Vowed I’d Never Write
o	http://northtemple.com/1608/
•	CSS Cheatsheet
o	https://htmlcheatsheet.com/css/
•	Designing for different screen sizes
o	https://uxdesign.cc/designing-for-different-screen-sizes-devices-part-1-47e6e481abde?gi=2974bb2a8963
•	Organising your CSS
o	https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Organizing

Acknowledgements
I would like to thank:
•	Code Institute for the excellent material and Medale Oluwafemi for the invaluable mentoring.
•	Karina Finnegan, in particular this(https://github.com/kairosity/ucd-resume) project, for design inspiration.
